...
class Losestate: public our::State {
    ...
    Sound loseSound = Sound("assets/sounds/lose.mp3", true);

    void onInitialize() override {
        loseSound = Sound("assets/sounds/lose.mp3", true);
        loseSound.play();
        ...
        menuMaterial->texture = our::texture_utils::loadImage("assets/textures/lose.jpeg");
